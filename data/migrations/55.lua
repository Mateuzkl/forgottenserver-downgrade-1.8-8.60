function onUpdateDatabase()
	...
	local indexes = {
		...
		{ "market_offers", "idx_market_offers_world_itemtype_sale", "INDEX `idx_market_offers_world_itemtype_sale` (`world_id`, `itemtype`, `sale`)" },
		{ "market_offers", "idx_market_offers_world_player", "INDEX `idx_market_offers_world_player` (`world_id`, `player_id`)" },

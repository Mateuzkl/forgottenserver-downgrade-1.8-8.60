local AttrSubId_ElementalStance = 3109

local condition = Condition(CONDITION_ATTRIBUTES)
condition:setParameter(CONDITION_PARAM_SUBID, AttrSubId_ElementalStance)
...
function spell.onCastSpell(creature, variant)
	...
	if player and player:getElementalStance() == STANCE_MASTER_OF_DECAY then
		player:removeCondition(CONDITION_ATTRIBUTES, CONDITIONID_COMBAT, AttrSubId_ElementalStance)

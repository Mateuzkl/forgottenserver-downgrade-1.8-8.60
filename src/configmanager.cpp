...
bool ConfigManager::load()
{
	...
	integers[Integer::AUGMENT_INCREASED_DAMAGE_PERCENT] = std::clamp<int32_t>(getGlobalInteger(L, "augmentIncreasedDamagePercent", 5), 0, 100);
	integers[Integer::AUGMENT_POWERFUL_IMPACT_PERCENT] = std::clamp<int32_t>(getGlobalInteger(L, "augmentPowerfulImpactPercent", 10), 0, 100);
	integers[Integer::AUGMENT_STRONG_IMPACT_PERCENT] = std::clamp<int32_t>(getGlobalInteger(L, "augmentStrongImpactPercent", 7), 0, 100);
